...
- (void)setNavigationButtonItems{
    ...
    // 将编辑按钮插入到默认按钮的左侧
    UIBarButtonItem *editButtonItem = [UIBarButtonItem barButtonItemWithImageName:@"edit" target:self action:@selector(editAction:)];
    
    [self addButtonItemWithLeftOfDefaultItem:editButtonItem];
}
